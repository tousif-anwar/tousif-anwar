...
**Routing:**  
React Router, Next.js App Router, Vue Router
...
**API Development:**  
REST APIs, GraphQL, Microservices, Authentication, Authorization, JWT, OAuth, API Gateway Patterns
...
**Data Engineering:**  
ETL/ELT Pipelines, Data Warehousing, Data Modeling, Dimensional Modeling, BigQuery, Snowflake, Redshift, Apache Spark, Airflow, dbt, Fivetran
...
**Deep Learning:**  
PyTorch, TensorFlow, Keras, Neural Networks, CNNs, Transfer Learning, Computer Vision, NLP, Word Embeddings, YOLO, OpenCV

**AI Systems:**  
LLM Applications, AI Automation, Prompt Engineering, AI Agents, Applied LLM Systems, Intelligent Decision Systems
